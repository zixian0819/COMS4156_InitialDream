    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            if 'Negative' in extracted_text:
                ...
                db.commit()
                return render_template('/ocr/upload.html', msg='Your test result is Negative, you will recieve Green Pass!')
            else:
                return render_template('/ocr/upload.html', msg='Automatic identification failed. Please request manual identification!')
            '''
